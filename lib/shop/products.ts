    ...
    variantGroups: [
      {
        ...
        columns: 2,
        options: [
          { id: 'h6', label: '6 inch', sublabel: 'Hammer-in edging', thumbImage: '/projects/photo28.jpg' },
          { id: 'h8', label: '8 inch', sublabel: 'Unlevel ground', thumbImage: '/projects/photo29.jpg', priceDelta: 4 },
          { id: 'h14', label: '14 inch', sublabel: 'Raised beds', thumbImage: '/projects/photo30.jpg', priceDelta: 12 },
          { id: 'h4', label: '4 inch', sublabel: 'Surface edging', thumbImage: '/projects/photo31.jpg', priceDelta: -3 },
        ],
      },
      {
        id: 'bend',
        ...
        columns: 3,
        options: [
          { id: 'straight', label: 'Straight', sublabel: '0° angle / linear edge', thumbImage: '/projects/photo28.jpg' },
          { id: 'r45', label: '45°', sublabel: 'Gentle curve', thumbImage: '/projects/photo29.jpg', priceDelta: 2 },
          { id: 'r90', label: '90°', sublabel: 'Sharp curve', thumbImage: '/projects/photo30.jpg', priceDelta: 3 },
        ],
      },
    ],
    features: [
        ...
        options: [
          {
            ...
            thumbImage: '/projects/photo37.jpg',
            priceDelta: -300,
          },
          {
            id: 'bonfire',
