...
export const services: Service[] = [
  ...
  },
  {
    ...
    description:
      "We specialize in structural welding for commercial and industrial projects. Our certified welders have extensive experience with steel structures, ensuring strength, durability, and code compliance. Whether it's new construction or facility upgrades, we deliver reliable structural solutions.",
    features: [
      'Certified welders',
      'Code-compliant work',
