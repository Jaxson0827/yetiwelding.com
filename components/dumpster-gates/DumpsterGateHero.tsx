...
export default function DumpsterGateHero() {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/dumpstergate/dumpster_gate_hero.png)',
          backgroundSize: '85%',
      ...
      >
        ...
        <motion.p
          ...
          variants={itemVariants}
        >
          Fully welded frame. Hinges and latch included.
        </motion.p>
      </motion.div>
