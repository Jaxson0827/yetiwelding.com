...
export default function PergolaHero() {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/pergola/pergola_hero.png)',
          backgroundSize: '85%',
      ...
      >
        ...
        <motion.p
          ...
          variants={itemVariants}
        >
          Design your steel shade structure. Choose size, height, color, and roof design.
        </motion.p>
